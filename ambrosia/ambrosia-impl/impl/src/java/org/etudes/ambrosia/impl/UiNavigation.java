...
//					String code = "parent.onToolExit = function(url) { document.form0.destination_.value=\"" + (this.destination != null ? this.destination.getDestination(context, focus) : "") + "\"; document.form0.submit();};";
			...
			if (confirm)
			{
				...
				secondary.println("<td style=\"padding:1em\" align=\"left\"><input type=\"button\" value=\""
						...
						+ id
						+ "()');return false;\" "
						+ ((this.confirmCancelIcon != null) ? "style=\"color:#fff; background-color:#15597e; padding-left:2em; background-image: url('"
				...
				{
					secondary.print(" style=\"color:#fff; background-color:#15597e; padding-left:2em; background-image: url('" + context.getUrl(selectedIcon) + "'); background-position: .2em; background-repeat: no-repeat;\"");
				}
			...
			if (selectRequirements || failedRequirements)
			{
				...
				secondary.println("<td style=\"padding:1em\" align=\"left\"><input type=\"button\" value=\""
						...
						+ ((this.requirementsOkIcon != null) ? "style=\"color:#fff; background-color:#15597e; padding-left:2em; background-image: url('"
		...
		switch (this.style)
		{
			...
			case button:
			{
				response.println("<input type=\"button\" "
						...
						+ description
						+ "\" "
						+ (((selectedIcon != null) && (this.iconStyle == IconStyle.left)) ? "style=\"color:#fff; background-color:#15597e; padding-left:2em; background-image: url('"
								+ context.getUrl(selectedIcon) + "'); background-position: .2em; background-repeat: no-repeat;\"" : "")
						+ (((selectedIcon != null) && (this.iconStyle == IconStyle.right)) ? "style=\"color:#fff; background-color:#15597e; padding-left:.4em; padding-right:2em; background-image: url('"
